...
conn = mysql.connector.connect(host="localhost",user="greshan")
...
def create_table():
	conn_db=mysql.connector.connect(host="localhost",db="ASGN",user="greshan")
...
def insert_values():
	db_conn=mysql.connector.connect(host="localhost",db="ASGN",user="greshan")
